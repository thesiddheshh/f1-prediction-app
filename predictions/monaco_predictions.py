...
YEAR_2024 = 2024
YEAR_2025 = 2025
EVENT_NAME_MONACO = "Monaco Grand Prix"
...
def get_weather_forecast(lat=43.7384, lon=7.4246, forecast_time="2025-05-25 13:00:00"):
...
def add_historical_performance(driver):
    historical_scores = {
        "VER": 90, "LEC": 85, "HAM": 92, "NOR": 78, "SAI": 80,
        "RUS": 83, "PIA": 76, "ALO": 87, "STR": 70, "OCO": 74
    }
...
def save_predictions_to_csv(results_df, filename="predictions/monaco_gp_2025.csv"):
...
def engineer_features(laps_data, quali_data, driver_to_team, team_performance_score, avg_position_change, rain_prob, temp):
    ...
    tyre_strat = add_tyre_strategy_impact(YEAR_2024, EVENT_ID_MONACO)
...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime": [70.669, 69.954, 70.129, None, 71.362, 71.213, 70.063, 70.942, 70.382, 72.563, 71.994, 70.924, 71.596]
})
...
if __name__ == "__main__":
    EVENT_ID_MONACO = get_event_id_by_name(YEAR_2024, EVENT_NAME_MONACO)
    laps_data = load_race_data(YEAR_2024, EVENT_ID_MONACO)
    ...
    merged_data = engineer_features(
        ...
        avg_position_change=average_position_change_monaco,
        rain_prob=rain_prob,
        temp=temperature
    )
